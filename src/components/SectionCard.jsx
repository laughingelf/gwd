      ...
      {section.type === "hero" && (
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          <div className="col-span-full max-w-sm mx-auto">
            ...
            <select
              value={section.content.displayType || "text"}
          ...
          {section.content.displayType === "text" && (
          ...
          {section.content.displayType === "logo" && (
            <div className="col-span-full">
              ...
              <input
                ...
                className="w-full max-w-sm mx-auto translate-x-25 md:translate-x-30"
              />
          ...
          <div className="col-span-full max-w-sm mx-auto">
            ...
            <select
              value={section.content.bgType || "color"}
              onChange={(e) => onUpdate({ bgType: e.target.value })}
              className="w-full border px-4 py-2 rounded max-w-xs mx-auto"
            >
          ...
          {(section.content.bgType || "color") === "color" && (
          ...
          {section.content.bgType === "image" && (
            <>
              ...
              <div className="mx-auto w-48 col-span-full">
                ...
                <input
                  type="color"
                  value={section.content.bgOverlayColor || "#000000"}
              ...
              <div className="mx-auto w-48 col-span-full">
                ...
                <input
                  ...
                  max="1"
                  step="0.05"
                  value={section.content.bgOpacity ?? 0.5}
