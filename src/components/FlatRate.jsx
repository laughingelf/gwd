    ...
    <section className="w-full px-4 py-12 ">
      <div className="max-w-4xl mx-auto space-y-12">
        ...
        <div className="space-y-10 mx-4 md:mx-24">
          ...
          <div>
            <Link to="/pricing" className="text-2xl md:text-3xl font-bold justify-center flex items-center gap-2 underline hover:scale-105" style={{ color: 'rgb(13, 182, 204)' }}>
              Google Business Profile Creation <ArrowRight size={22} />
            </Link>
            <p className="text-xl text-left max-w-2xl mt-2">
          ...
          <div>
            <Link to="/pricing" className="text-2xl md:text-3xl font-bold flex justify-center items-center gap-2 hover:scale-105 underline" style={{ color: 'rgb(13, 182, 204)' }}>
              Single Page Portfolio Website <ArrowRight size={22} />
            </Link>
            <p className="text-xl text-left max-w-3xl mt-2">
